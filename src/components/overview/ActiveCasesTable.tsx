...
export function ActiveCasesTable({ cases, pageSize = 15 }: ActiveCasesTableProps) {
  ...
  const paginatedCases = sortedCases.slice((safePage - 1) * pageSize, safePage * pageSize);
